...
class home : AppCompatActivity() {
    ...
    fun showToast(text: String){
        Toast.makeText(this@home, text, Toast.LENGTH_LONG).show()
    }
    ...
    fun handleInserts() {
        insertBtn.setOnClickListener {
            try {
                dbHelper.insertData(nameTxt.text.toString(),passTxt.text.toString(),
        ...
        updateBtn.setOnClickListener {
            try {
                val isUpdate = dbHelper.updateData(idTxt.text.toString(),
                    ...
                    passTxt.text.toString(), typeTxt.text.toString())
                if (isUpdate == true)
